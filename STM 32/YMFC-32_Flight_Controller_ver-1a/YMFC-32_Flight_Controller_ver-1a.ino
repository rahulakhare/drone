...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0.2;               //Gain setting for the pitch and roll P-controller (default = 1.3).
float pid_i_gain_roll = 0.000;              //Gain setting for the pitch and roll I-controller (default = 0.04).
float pid_d_gain_roll = 7;              //Gain setting for the pitch and roll D-controller (default = 18.0).
...
float pid_p_gain_yaw = 1.5;                  //Gain setting for the pitch P-controller (default = 4.0).
...
int16_t manual_acc_pitch_cal_value = 304;
int16_t manual_acc_roll_cal_value = -131;
...
int16_t manual_gyro_pitch_cal_value = 156;
int16_t manual_gyro_roll_cal_value = -176;
int16_t manual_gyro_yaw_cal_value = -58;
