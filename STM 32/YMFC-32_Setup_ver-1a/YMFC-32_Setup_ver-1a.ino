...
int16_t manual_acc_pitch_cal_value = 313;
int16_t manual_acc_roll_cal_value = -116;
...
int16_t manual_gyro_roll_cal_value = -192;
int16_t manual_gyro_yaw_cal_value = -51;
...
void setup() {
  ...
  void timer_setup();                                                //Setup the timers for the receiver inputs and ESC's output.
...
void  print_intro();                                                //Print the intro on the serial monitor.
}
